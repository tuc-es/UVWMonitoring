...
const uint8_t lut1[32] = {0x1,0x12,0x1,0x12,0x61,0x72,0x61,0x72,
    0x1,0x11,0x4,0x14,0x68,0x78,0x6c,0x7c,
    0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,
    0x1,0x1,0x4,0x4,0x1,0x1,0x4,0x4};
const uint8_t lut2[32] = {0x0,0x8,0x2,0x0,0x4,0xc,0x6,0x4,
    0x1,0x9,0x3,0x1,0x0,0x8,0x2,0x0,
    0x0,0x8,0x12,0x0,0x4,0xc,0x16,0x4,
    0x11,0x19,0x13,0x11,0x0,0x8,0x12,0x0};
const uint8_t lut3[32] = {0x4,0x4,0x4,0x4,0x4,0x0,0x5,0x1,
    0x4,0x0,0x6,0x2,0x4,0x0,0x7,0x3,
    0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,
    0x0,0x0,0x2,0x2,0x0,0x0,0x3,0x3};
const uint8_t lut4[32] = {0x0,0x0,0x0,0x0,0x1,0x1,0x1,0x1,
    0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,
    0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
    0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0};
const uint8_t lut5[32] = {0x2,0x2,0x2,0x2,0x2,0x2,0x2,0x2,
    0x0,0x1,0x2,0x2,0x0,0x1,0x2,0x2,
    0x2,0x2,0x2,0x2,0x6,0x6,0x6,0x6,
    0x0,0x1,0x2,0x2,0x4,0x4,0x6,0x6};
...
const uint8_t lut11[32] = {0x10,0x11,0x0,0x1,0x18,0x19,0x0,0x1,
    0xd4,0xd4,0x0,0x1,0xdc,0xdc,0x0,0x1,
    0x0,0x1,0x0,0x1,0xb8,0xb9,0xba,0xba,
    0xc0,0xc1,0xc4,0xc4,0xf8,0xf9,0xfe,0xfe};
const uint8_t lut12[32] = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6,
...
void monitorUpdate(uint32_t apValues) {
  ...
  uint32_t lut1input = (uvwState20>0?2:0) | (uvwState21>0?4:0) | ((lut0output & 32)>0?16:0) | (uvwState19 & 1) | (lut0output & 8);
  uint32_t lut1output = lut1[lut1input];
  uint32_t lut2input = ((apValues & 64)>0?1:0) | ((apValues & 128)>0?2:0) | ((lut0output & 32)>0?16:0) | (apValues & 12);
  uint32_t lut2output = lut2[lut2input];
  uint32_t lut3input = (lut0output & 3) | (lut2output & 28);
  uint32_t lut3output = lut3[lut3input];
  uint32_t lut4input = ((lut0output & 64)>0?8:0) | ((lut3output & 1)>0?16:0) | (lut2output & 3) | (lut3output & 4);
  uint32_t lut4output = lut4[lut4input];
  uint32_t lut5input = ((lut4output & 1)>0?8:0) | (uvwState18>0?16:0) | (lut1output & 1) | (lut3output & 2) | (lut0output & 4);
  ...
  uint32_t lut11input = ((apValues & 32)>0?2:0) | (uvwState5>0?4:0) | (uvwState6>0?8:0) | (lut10output & 1) | (apValues & 16);
  uint32_t lut11output = lut11[lut11input];
  uint32_t lut12input = (uvwState21>0?2:0) | (uvwState20>0?8:0) | (lut0output & 5) | (lut1output & 16);
  uint32_t lut12output = lut12[lut12input];
  uint32_t lut13input = (uvwState4>0?2:0) | (uvwState3>0?16:0) | (lut11output & 1) | (apValues & 12);
  ...
  uvwState5 = (lut11output & 16);
  uvwState6 = (lut11output & 128);
  ...
  uvwState19 = (lut12output & 4);
  uvwState20 = (lut12output & 16);
  uvwState21 = (lut1output & 64);
}
...
- LUT 1 has:
  ...
  -> Outputs new_n88 uvwState0incoming19 uvwState0incoming20 uvwState0incoming21 uvwState19incoming0 uvwState21incoming0 uvwState21Next
- LUT 2 has:
...
- LUT 4 has:
  ...
  -> Outputs new_n75
- LUT 5 has:
  -> Inputs new_n88 new_n76 new_n79 new_n75 uvwState18
