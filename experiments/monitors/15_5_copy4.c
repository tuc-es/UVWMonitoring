...
const uint16_t lut0[32] = {0x300,0x301,0x340,0x300,0x302,0x307,0x342,0x302,
    0x380,0x381,0x3c0,0x380,0x300,0x301,0x340,0x300,
    0x318,0x309,0xf50,0x318,0x31a,0x30f,0xf52,0x31a,
    0x398,0x389,0xfd0,0x398,0x318,0x309,0xf50,0x318};
const uint8_t lut1[32] = {0x10,0x0,0x50,0x44,0x18,0x8,0x58,0x4c,
    0x80,0x80,0xe0,0xe4,0x10,0x0,0x50,0x44,
    0x11,0x1,0x10,0x0,0x1b,0xb,0x18,0x8,
    0x81,0x81,0x80,0x80,0x11,0x1,0x10,0x0};
const uint8_t lut2[32] = {0x1,0x1,0x0,0x1,0x0,0x0,0x0,0x0,
    0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x0,
    0x1,0x1,0x1,0x1,0x0,0x0,0x0,0x0,
    0x1,0x0,0x1,0x1,0x0,0x0,0x0,0x0};
const uint8_t lut3[32] = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
    0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,
    0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
    0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0};
const uint8_t lut4[32] = {0x4,0x11,0x4,0x11,0x64,0x71,0x64,0x71,
    0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,
    0x4,0x14,0x2,0x12,0x68,0x78,0x6a,0x7a,
    0x4,0x4,0x2,0x2,0x4,0x4,0x2,0x2};
const uint8_t lut5[32] = {0x2,0x0,0x2,0x2,0x2,0x1,0x2,0x2,
    0x2,0x0,0x2,0x2,0x2,0x1,0x2,0x2,
    0x2,0x0,0x2,0x2,0x2,0x1,0x2,0x2,
    0x6,0x4,0x6,0x6,0x6,0x4,0x6,0x6};
...
const uint8_t lut11[32] = {0x0,0x0,0x0,0x0,0x18,0x0,0x18,0x0,
    0x0,0x0,0x0,0x6,0x18,0x5,0x18,0x7,
    0x4,0x4,0x4,0x4,0x1c,0x4,0x1c,0x4,
    0x4,0x4,0x4,0x6,0x1c,0x5,0x1c,0x7};
...
void monitorUpdate(uint32_t apValues) {
  uint32_t lut0input = ((apValues & 256)>0?16:0) | (apValues & 15);
  uint32_t lut0output = lut0[lut0input];
  uint32_t lut1input = ((lut0output & 128)>0?1:0) | ((apValues & 32)>0?2:0) | ((apValues & 64)>0?4:0) | ((apValues & 128)>0?8:0) | (apValues & 16);
  uint32_t lut1output = lut1[lut1input];
  uint32_t lut2input = (apValues & 3) | (lut0output & 4) | (lut1output & 24);
  uint32_t lut2output = lut2[lut2input];
  uint32_t lut3input = ((lut2output & 1)>0?8:0) | ((lut1output & 32)>0?16:0) | (lut1output & 5) | (lut0output & 2);
  uint32_t lut3output = lut3[lut3input];
  uint32_t lut4input = (uvwState20>0?2:0) | (uvwState21>0?4:0) | ((lut0output & 64)>0?8:0) | (uvwState19 & 1) | (lut0output & 16);
  uint32_t lut4output = lut4[lut4input];
  uint32_t lut5input = (uvwState18>0?16:0) | (lut3output & 1) | (lut1output & 2) | (lut4output & 4) | (lut0output & 8);
  ...
  uint32_t lut11input = (uvwState21>0?2:0) | (uvwState20>0?4:0) | (lut0output & 9) | (lut4output & 16);
...
- LUT 0 has:
  -> Inputs a1 a2 b1 b2 m
  -> Outputs new_n34 new_n40 new_n64 new_n79 new_n82 uvwState0incoming0 uvwState9incoming1 uvwState11incoming1 uvwState17incoming0 uvwState17Next uvwState18incoming0 uvwState18Next
- LUT 1 has:
  -> Inputs uvwState11incoming1 c2 d1 d2 c1
  -> Outputs new_n46 new_n76 new_n70 new_n52 new_n65 new_n74 uvwState13incoming1 uvwState15incoming1
- LUT 2 has:
  -> Inputs a1 a2 new_n64 new_n52 new_n65
  -> Outputs new_n69
- LUT 3 has:
  -> Inputs new_n46 new_n40 new_n70 new_n69 new_n74
  -> Outputs new_n75
- LUT 4 has:
  -> Inputs uvwState19 uvwState20 uvwState21 uvwState9incoming1 new_n82
  -> Outputs uvwState0incoming19 uvwState0incoming20 new_n88 uvwState0incoming21 uvwState19incoming0 uvwState21incoming0 uvwState21Next
- LUT 5 has:
  -> Inputs new_n75 new_n76 new_n88 new_n79 uvwState18
...
- LUT 11 has:
  -> Inputs new_n34 uvwState21 uvwState20 new_n79 uvwState19incoming0
